...
== Motivation
So why use this at all? Say you have some Rails helpers to define but Rails doesn't get
loaded until after irbrc. Simply pass Ripl.after_rc a block to be called when Rails is available.
